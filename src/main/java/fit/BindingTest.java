...
public class BindingTest {
	...
	protected void setUp() throws Exception {
		...
		Parse table = new Parse(
				"<table><tr><td>123</td><td>321</td><td>abc</td><td></td></tr></table>");
	...
	public void testConstruction() throws Throwable {
		...
		assertEquals(Binding.QueryBinding.class,
				Binding.create(fixture, "intMethod!").getClass());
		assertEquals(Binding.SetBinding.class,
				Binding.create(fixture, "intField").getClass());
		assertEquals(Binding.RecallBinding.class,
				Binding.create(fixture, "intField=").getClass());
		assertEquals(Binding.SaveBinding.class,
				Binding.create(fixture, "=intMethod()").getClass());
		assertEquals(Binding.SaveBinding.class,
				Binding.create(fixture, "=intField").getClass());
	}
	...
	private void checkForMethodBinding(String name, boolean expected)
			throws Throwable {
	...
	private void checkForFieldBinding(String name, boolean expected)
			throws Throwable {
		Binding binding = null;
		try {
			binding = Binding.create(fixture, name);
